...
export const Route = createFileRoute('/_landing/downloads')({
  head: () =>
    getMarketingHead({
      title: 'Downloads',
...
function Downloads() {
  return (
    ...
    >
      ...
      <DownloadSection
        title="Mobile Apps"
        description="Your business in the palm of your hand"
        links={downloads}
      />
      <DownloadSection
        title="Plugins"
        description="Polar integrated in your favourite apps"
        links={plugins}
      />
    </Box>
  )
...
function DownloadSection({ title, description, links }: DownloadSectionProps) {
  return (
