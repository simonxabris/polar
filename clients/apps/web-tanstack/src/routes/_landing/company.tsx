...
import { investors } from '@/components/Landing/company/investors'
import { TeamCarouselWrapper } from '@/components/Landing/company/TeamCarouselWrapper'
...
export const Route = createFileRoute('/_landing/company')({
  head: () =>
    getMarketingHead({
      title: 'Company',
      description:
